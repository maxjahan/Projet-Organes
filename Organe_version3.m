...
%             title('left hip')
  ...
  if i<700 %On suppose que le patient est sur du plat pendant au moins 7 sec
    ...
    elseif i==700
            ...
            left_ankle_2 = (left_ankle-a_ankle)/(moyenne_sommet_plat_ankle-moyenne_minima_plat_ankle);%on normalise la fonction (à faire au fur et à mesure dans la version finale!!!!!)
            figure
            plot(left_ankle_2)
            hold on
            line([1 ll],[0.1 0.1],'Color','red')
